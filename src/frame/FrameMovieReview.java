...
public class FrameMovieReview extends JPanel {
   ...
   public FrameMovieReview() {
      ...
      JRadioButton movie1 = new JRadioButton("라라랜드");//////그리드에 붙임
      ...
      ButtonGroup group2 = new ButtonGroup();//배타적기능 중복선택불가
      group2.add(point1);
      group2.add(point2);
      group2.add(point3);
      group2.add(point4);
      ...
      // 작성자 이름
      TextField reviewName = new TextField("작성자 이름", 40);//회원가입
      ...
      review.addTextListener(new TextListener() {
         ...
         @Override
         public void textValueChanged(TextEvent e) {///예외처리
      ...
      btn.addActionListener(new ActionListener() {
         ...
         @Override
         public void actionPerformed(ActionEvent e) {
            if (point1.isSelected() || point2.isSelected() || //예외처리
               ...
               for (int i = 0; i < movie.length; i++) {
                  ...
                  //작성한 후기를 영화 리스트에 추가
                  new MovieDAO().inputReview(///데이터베이스용
